...
export class ShopPrintBillButton extends Component {
    static template = "pos_shop.ShopPrintBillButton";
    ...
    async click() {
        ...
        })) || this.pos.showTempScreen("ShopBillScreen");
    }
}

ProductScreen.addControlButton({
    component: ShopPrintBillButton,
    condition: function () {
